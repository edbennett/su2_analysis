...
def do_one_loop_matching(
    ...
    bare_decay_constant = get_measurement(
        ensemble_descriptor, f"{channel_name}_decay_const"
    )
    ...
    renormalised_decay_const_value = Z_coefficient.value * bare_decay_constant.value
