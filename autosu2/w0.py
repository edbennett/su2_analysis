...
def plot_measure_and_save_w0(
    ...
    if (
        ...
        and (
            measurement_is_up_to_date(
                simulation_descriptor, "w0p", compare_file=filename, free_parameter=W0
            )
            and measurement_is_up_to_date(
                simulation_descriptor, "w0c", compare_file=filename, free_parameter=W0
            )
        )
    ):
        # Already up to date
