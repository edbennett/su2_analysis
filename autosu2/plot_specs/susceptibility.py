    ...
    for Nf, marker in (0, 's'), (2, '*'):
        ...
        ax.errorbar(
            ...
            yerr=uncertainty_ratio_sqrtsigma(
                subset_data.suscept, subset_data.suscept_err,
                subset_data.sqrtsigma, subset_data.sqrtsigma_err
            ),
...
def generate(data, ensembles):
    ...
    merged_data['uncertainty_chi_top_14_hat'] = (
        (0.25 * merged_data.value_chi_top ** -0.75
         * merged_data.uncertainty_chi_top * merged_data.value_w0) ** 2
        + (merged_data.value_chi_top ** 0.25
    ...
    merged_data['uncertainty_chi_top_14_over_sqrtsigma'] = (
        uncertainty_ratio_sqrtsigma(
